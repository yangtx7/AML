...
DATASET_NAME_MAPPING = {
    ...
    "jmhessel/newyorker_caption_contest": ("image", "image_description"),
    "skiracer/simpsons_blip_captions": ("image", "text"),
...
def main():
    ...
    dataset_name = "skiracer/simpsons_blip_captions"
